...
# Do not change anything above this line
    ...
    def detectLoop(self):
        ...
        #flody cycle detection algo
        #when slow will reach middle of the ll fast will reach the end (for linear linked list)
        #if the ll is not linear->ll is circular
        if self.head==None:
        	return 0
        ...
        while fast!=None and fast.next!=None:
        	...
        	fast=fast.next.next
        	if slow==fast:
        		#after some circulation only it can become same
        		return 1
